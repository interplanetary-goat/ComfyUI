...
# Install Python 3.12, pip, git, SSH server, and other dependencies
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    git \
    openssh-server \
    # Add any other system dependencies your project might need here (e.g., build tools, libs for AV)
    build-essential \
